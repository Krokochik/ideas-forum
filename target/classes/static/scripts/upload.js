    ...
    freader.onload = (function (f) {
      return function (e) {
        sendRequest('POST', "https://ideas-forum.herokuapp.com/profile", {
          ...
          .then(data => {
            if ((document.getElementById("nickname").value.trim().length >= 4) || (document.getElementById("imagePreview").style !== document.getElementById("avatar").style))
...
function dismissChanges() {
  ...
  document.getElementById('imagePreview').style.width = '';
  document.getElementById('imagePreview').style.height = '';
