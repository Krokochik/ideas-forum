    ...
    async submitCode() {
        if (this.form.checkValidity()) {
            ...
            const isCodeRight = async (code) => {
                ...
                loader.style.marginTop = modalNeck.style.marginTop - modalHeader.style.marginTop / 2 - loader.offsetHeight;
            ...
            if (await isCodeRight(this.code)) {
                ...
                document.getElementById("no").onclick = "window.location.reload()";
            } else {
                badCode();
                this.editable = true;
                this.inputs.forEach((input) => {
